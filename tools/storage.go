...
func registerStorageTools(s *mcp.Server, client proxmoxClient) {
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		if err != nil {
			return errorResult(fmt.Errorf("list_storage_content: %w", err))
		}
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		if err != nil {
			return errorResult(fmt.Errorf("get_storage_content_info: %w", err))
		}
